---
title: opengl12光照贴图
date: 2023-12-16 22:42:55
tags:
- opengl
- java
cover: https://view.moezx.cc/images/2020/02/23/bid3dxh.jpg
...
//        creates the necessary function pointers for OpenGL's functions, making them accessible and usable within your Java code.
        ...
        int diffuseMap = loadTexture("src/main/resources/container2.png");
        int specularMap = loadTexture("src/main/resources/container2_specular.png");
        int matrixMap = loadTexture("src/main/resources/matrix.jpg");
        ...
        while(!GLFW.glfwWindowShouldClose(window)){
            ...
            shaderProgram.setVec3("light.specular", 1.0f, 1.0f, 1.0f);
            shaderProgram.setVec3("light.position", lightPos);
            shaderProgram.setInt("matrix",2);
            shaderProgram.setVec3("matrixLight",new Vector3f(1f,1f,1f));
...
void main()
{
    ...
    //matix
    vec3 matrix = vec3(texture(matrix,TexCoords));
    vec3 matrixresult = matrixLight* matrix;

    vec3 result = ambient + diffuse + specular + matrixresult;
    FragColor = vec4(result,1.0);
